...
const { assignPropertyToTenant ,getOwnerInfo , getProfile,updateProfile, getTenantInfo} = require("../controller/TenantController");
...
router.get("/tenant-info",authMiddleware, getTenantInfo);
